<div id="{$properties.uniqueId}">
	...
	{else}
		...
		{else}
			...
			<tr searchterm="{$row.metadata.search_term|htmlentities}" datatable_following="{$row.metadata.datatable_following}" datatable_previous="{$row.metadata.datatable_previous}">
